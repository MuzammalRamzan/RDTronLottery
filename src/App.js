...
const App = () => {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <p style={{ maxWidth: "450px", padding: "25px" }}>
          RDTronlottery is a decenterlized community raffle smart contract, its
          design is intented to change the financial lives of two praticipants
          each time the raffle is run and with a low cost of 10 TRX!
        </p>
      </div>
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <table>
          ...
          <tr>
            <td className="center">Smart contract address</td>
            <td className="center">
              <a
                target="_blank"
          ...
          <tr>
            <td className="center">Pool Prize Balance</td>
            <td className="center">{poolPrize}</td>
          </tr>
          <tr>
            <td className="center">Sold Tickets</td>
            <td className="center">{soldTickets}</td>
          </tr>
          <tr>
            <td className="center">Available Tickets</td>
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <table>
          ...
          <tr>
            <td className="center">Your address</td>
            <td className="center">
              <a
                target="_blank"
          ...
          <tr>
            <td className="center">Your Balance</td>
            <td className="center">{trxtBalance}</td>
          </tr>
          <tr>
            <td className="center">Bought Tickets</td>
            <td className="center">{boughtTickets}</td>
          </tr>
          <tr>
            <td className="center">My Refferals</td>
            <td className="center">{myReferal}</td>
          </tr>

          <tr>
            <td className="center">Your Refferal Link</td>
            <td className="center">
              <Input
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <p style={{ maxWidth: "450px" }}>
          RDTronlottery does not constitute an investment platform, so each
          participant recognizes that it is a raffle executed randomly by the
          smart contract with each participant interacts, thus always selecting
          two winners.
        </p>
      </div>
      <div
